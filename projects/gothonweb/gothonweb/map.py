...
throw_bomb_death = Room("Throw Bomb Death",
"""
...
code_death.add_paths({
    'death': generic_death
})

throw_bomb_death.add_paths({
    'death': generic_death
})
